/* ============================================================================
   ...
   Adapted from brainphreak.net for theamunra
   ============================================================================ */
...
const filesystem = {
  ...
  THE AMUN RA TERMINAL - HACKER'S GUIDE
============================================
...
` },
                    ...
                    'amunRa': {
                        ...
                        lastModified: defaultTimestamp,
                        contents: {
                            '.bash_history': { type: 'file', owner: 'amunra', group: 'amunra', size: 0, lastModified: defaultTimestamp, content: '' },
                            'Documents': { type: 'directory', owner: 'amunra', group: 'amunra', size: 4096, lastModified: defaultTimestamp, contents: {
                                'readme.txt': { type: 'file', owner: 'amunra', group: 'amunra', size: 256, lastModified: defaultTimestamp, content: `Hell Sys Terminal
...
- The Amun Ra Crew` }
                            ...
                            'Downloads': { type: 'directory', owner: 'amunra', group: 'amunra', size: 4096, lastModified: defaultTimestamp, contents: {} },
                            'Music': { type: 'directory', owner: 'amunra', group: 'amunra', size: 4096, lastModified: defaultTimestamp, contents: {} },
                            'Pictures': { type: 'directory', owner: 'amunra', group: 'amunra', size: 4096, lastModified: defaultTimestamp, contents: {} },
                            'Videos': { type: 'directory', owner: 'amunra', group: 'amunra', size: 4096, lastModified: defaultTimestamp, contents: {} },
                            'tools': { type: 'directory', owner: 'amunra', group: 'amunra', size: 4096, lastModified: defaultTimestamp, contents: {
                                'scanner.py': { type: 'file', owner: 'amunra', group: 'amunra', size: 150, lastModified: defaultTimestamp, content: `#!/usr/bin/env python3
# Amun Ra Network Scanner v1.0
import socket
import sys
...
if __name__ == "__main__":
    print("Amun Ra Scanner - Use responsibly")` }
                            }}
                        }
                    }
                }
...
amunra:x:1001:1001:Amun Ra:/home/amunra:/bin/bash` },
...
amunra:$6$salt$3N9mPr2tY5wV8xU1hK7jL4gF6sD8aM2bC3nV1mR9tP4lH6kJ8fG5dS3aM7nV1rP9:19000:0:99999:7:::` },
                    'sudoers': { type: 'file', owner: 'root', group: 'root', size: 100, lastModified: defaultTimestamp, content: `# Sudoers file
root    ALL=(ALL:ALL) ALL
user    ALL=(ALL:ALL) ALL
amunra    ALL=(ALL:ALL) ALL` },
            ...
            'proc': {
                ...
                contents: {
                    'version': {
                        ...
                        content: 'Linux version 5.15.0-amunra (gcc version 11.2.0) #1 SMP PREEMPT The Amun Ra'
                    },
                    'cpuinfo': {
                        type: 'file',
            ...
            'var': {
                ...
                contents: {
                    'log': {
                        ...
                        lastModified: defaultTimestamp,
                        contents: {
                            'syslog': { type: 'file', owner: 'root', group: 'root', size: 500, lastModified: defaultTimestamp, content: `Jan 15 08:00:01 amunra CRON[1234]: (root) CMD (run-parts /etc/cron.hourly)
Jan 15 08:15:32 amunra sshd[5678]: Accepted publickey for amunra from 192.168.1.50
Jan 15 08:30:00 amunra kernel: [UFW BLOCK] IN=eth0 SRC=10.0.0.5 DST=192.168.1.100
Jan 15 09:00:01 amunra systemd[1]: Started Daily apt upgrade and clean activities.` },
                            'auth.log': { type: 'file', owner: 'root', group: 'root', size: 300, lastModified: defaultTimestamp, content: `Jan 15 07:55:12 amunra sshd[4321]: Failed password for invalid user admin from 203.0.113.50
Jan 15 07:55:15 amunra sshd[4321]: Failed password for invalid user root from 203.0.113.50
Jan 15 08:15:32 amunra sshd[5678]: Accepted publickey for amunra from 192.168.1.50` }
                        }
                    },
                    'www': {
...
<html>
<head><title>The Amun Ra</title></head>
<body>
<h1>Welcome to The Amun Ra</h1>
...
print("Amun Ra Scanner - Curiosity is not a crime")`
                                    },
                                    'recon.sh': {
                                        type: 'file',
                                        owner: 'root', group: 'root', size: 180, lastModified: defaultTimestamp,
                                        content: `#!/bin/bash
# Amun Ra Recon Script
...
const users = {
    ...
    amunra: { uid: '1001', gid: '1001', home: '/home/amunra', shell: '/bin/bash', password: 'curiosity' }
};

// Sudoers list
const sudoers = ['root', 'user', 'amunra'];
